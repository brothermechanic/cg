...
MYD=$(get_version_component_range 1).$(get_version_component_range 2)
...
src_prepare() {
	epatch "${FILESDIR}"/${PN}-7.5.18-gcc53.patch
	local cuda_supported_gcc

	cuda_supported_gcc="5.1 5.2 5.3"
