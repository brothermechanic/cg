...
HOMEPAGE="https://github.com/wjakob/glfw"
COMMIT="38f86be2c9495a4aaacbf5360c0f79f729576a9d"
SRC_URI="https://github.com/wjakob/glfw/archive/${COMMIT}.tar.gz -> ${P}-${COMMIT:0:7}.tar.gz"
