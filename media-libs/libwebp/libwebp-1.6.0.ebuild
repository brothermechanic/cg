...
IUSE="cpu_flags_arm_neon cpu_flags_x86_avx2 cpu_flags_x86_sse2 cpu_flags_x86_sse4_1 gif +jpeg +lossless +png static-libs swap-16bit-csp tiff utils viewer"
...
multilib_src_configure() {
	...
	local mycmakeargs=(
		...
		-DWEBP_ENABLE_AVX2="$(usex cpu_flags_x86_avx2)"
		-DWEBP_ENABLE_SSE4.1="$(usex cpu_flags_x86_sse4_1)"
		-DWEBP_ENABLE_NEON="$(usex cpu_flags_arm_neon)"
