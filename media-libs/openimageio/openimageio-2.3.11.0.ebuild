...
src_prepare() {
	...
	sed -i -e 's/include <OpenEXR/include <OpenEXR-3/' \
		src/dpx.imageio/dpxinput.cpp src/openexr.imageio/exrinput.cpp src/openexr.imageio/exroutput.cpp src/openexr.imageio/exrinput_c.cpp src/oiiotool/oiiotool.cpp || die
