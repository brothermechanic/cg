...
SRC_URI="http://ppa.launchpad.net/makehuman-official/makehuman-11x/ubuntu/pool/main/m/makehuman/makehuman_1.1.0~rc3+20160416132607.orig.tar.gz"
...
DEPEND="${RDEPEND}"
PDEPEND="blender? ( media-plugins/makehuman-mhx2[blender] )"
