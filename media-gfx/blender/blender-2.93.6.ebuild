...
inherit git-r3 check-reqs cmake flag-o-matic pax-utils python-single-r1 toolchain-funcs xdg-utils
...
RDEPEND="${PYTHON_DEPS}
	...
	alembic? ( =media-gfx/alembic-1.8.2:=[boost(+),-hdf5] )
