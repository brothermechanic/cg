...
SRC_URI="https://github.com/dreamworksanimation/${PN}/archive/v${PV}.tar.gz -> ${P}.tar.gz
	https://github.com/dracwyrm/gentoo-patches/raw/master/${PN}/${PN}-4.0.2-patchset-01.tar.xz"
...
PATCHES=(
	"${FILESDIR}/0001-Change-hardcoded-paths-to-GNUInstallDirs-variables.patch"
	"${FILESDIR}/0002-Use-PkgConfig-to-find-IlmBase-and-OpenEXR.patch"
	"${FILESDIR}/0003-Boost-1.65-NumPy-support.patch"
