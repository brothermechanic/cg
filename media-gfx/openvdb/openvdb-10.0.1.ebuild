...
IUSE="abi8-compat abi9-compat abi10-compat ax benchmark +blosc cuda doc examples +intrinsics
...
PATCHES=(
	...
	#"${FILESDIR}/${PN}-10.0.0-remesh.patch"
...
src_prepare() {
	sed -i -e "s|DESTINATION doc|DESTINATION share/doc/${PF}|g" doc/CMakeLists.txt || die
